                    ...
                    <c:forEach var="movie" items="${sessionScope.InTheatersMovies}">
                        <div class="card-header" style="display: block;position: relative;padding: 10px;max-width: 300px;font-weight: 300;" layout horizontal center>
                            ...
                            <div style="background-color:white;padding-bottom: 10px;box-shadow: 3px 3px 3px #d3d1d1;">
                                <div class="h2" style="max-width: 300px;margin-left: auto;margin-right: auto;padding-left: 10px;  padding-right: 10px;font-weight: 300;"><a href="GetMovieById?Id=<c:out value='${movie.id}'/>"><c:out value="${movie.title}"/></a></div>
