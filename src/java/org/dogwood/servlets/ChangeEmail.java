...
//        if (name == null || currentEmail == null || newEmail == null) {
//            request.getRequestDispatcher("GetInTheatersMovies").forward(request, response);
//        }
//        if (!Database.getInstance().changeEmail(name, currentEmail, newEmail)) {
//            session.setAttribute("ChangeEmailFail", "Incorrect password.");
//        }
//        else {
//            session.setAttribute("ChangeEmailSuccess", "Successfully changed password.");   
//        }
